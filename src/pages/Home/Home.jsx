          ...
          >
            ...
            <Typography sx={{ textIndent: '10px' }}>
              * Mình chỉ mới test trên một số file lịch học của bạn mình nên còn
              nhiều thiếu sót, có thể sẽ không hoạt động theo file lịch học của
              bạn.
            </Typography>
            <Typography sx={{ textIndent: '10px' }}>
              * Chỉ hoạt động được trên lịch của Năm Học: 2023-2024 Học Kì: 02.
              Học kì khác sẽ không hoạt động!
            </Typography>
            <Typography
